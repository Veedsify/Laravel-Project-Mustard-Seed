    ...
    <form>
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div class="col-span-2">
                <label for="country" class="block text-sm font-medium text-gray-700">Name (Landmark, Building)</label>
                <input name="name" type="text" autocomplete="street-address" wire:model="name"
                    class="mt-1 block w-full py-4 font-lg px-4 border  border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm" />
                @if ($errors->has('name'))
            ...
            <div class="col-span-2">
                <label for="country" class="block text-sm font-medium text-gray-700">Address</label>
            ...
            <div>
                <label for="country" class="block text-sm font-medium text-gray-700">States</label>
