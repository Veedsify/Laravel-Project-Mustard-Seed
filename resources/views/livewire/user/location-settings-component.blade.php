        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div class="col-span-2">
                ...
                <input name="name" type="text" autocomplete="street-address" wire:model="name"
                    class="mt-1 block w-full py-4 font-lg px-4 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm" />
                @if ($errors->has('name'))
            ...
            <div wire:loading wire:target="save" class="col-span-2">
                <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-teal-500" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-span-2">
                <input type="submit" wire:click.prevent="save" value="Update Location"
                    class="mt-1 block w-full py-4 font-lg px-4 border border-transparent bg-teal-600 text-white rounded-md shadow-sm focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm cursor-pointer">
            </div>
        </div>
    </form>
</section>
