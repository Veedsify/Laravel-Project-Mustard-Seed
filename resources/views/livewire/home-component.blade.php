                ...
                <div class="row justify-content-between">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 my-auto">
                        <div class="hero-caption-one mb-20">
                            <h4 class="key-title font-700 mb-20 wow-dis fadeInUp" data-wow-delay="0.0s">Speak Hope
                                for the Homeless</h4>
                            <h1 class="title font-700 wow-dis fadeInUp" data-wow-delay="0.1s">Donate to children &
                                senior citizens</h1>
                            <p class="pera wow-dis fadeInUp" data-wow-delay="0.3s">Involves donating one's body
                                after death for medical research, education, or anatomical dissection. Body
    ...
    <section class="helpful-area">
        <div class="container">
            <div class="row gy-24">
                ...
                <div class="col-xl-3 col-md-6 col-lg-6">
                    <div class="helpful-card h-calc  wow-dis fadeInLeft" data-wow-delay="0.0s">
                        <div class="helpful-card-icon">
                ...
                <div class="col-xl-3 col-md-6 col-lg-6">
                    <div class="helpful-card h-calc wow-dis fadeInRight" data-wow-delay="0.0s">
                        <div class="helpful-card-icon">
                ...
                <div class="col-xl-3 col-md-6 col-lg-6">
                    <div class="helpful-card h-calc  wow-dis fadeInRight" data-wow-delay="0.2s">
                        <div class="helpful-card-icon">
                ...
                <div class="col-lg-7 my-auto">
                    ...
                    <div class="section-tittle mb-50">
                        ...
                        <p class="pera">When deciding which charity to donate to, it's important to do your
                            search and find one that aligns with your values and interests.</p>
                    </div>
