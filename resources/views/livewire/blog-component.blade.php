                    ...
                    <div class="single-blog h-calc">
                        <div class="blog-img">
                            <a href="{{route('blog.details', [$blog->slug])}}">
                                <img src="{{asset('storage/'. $blog->image)}}" class="img-fluid w-100" alt="{{$blog->title}}">
                            </a>
                            <div class="brush-bg" data-date="{{date('d', strtotime($blog->created_at))}} {{date('M', strtotime($blog->created_at))}} {{date('Y', strtotime($blog->created_at))}}">
