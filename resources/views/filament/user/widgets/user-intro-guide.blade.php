    ...
    <x-filament::section>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div class="relative w-full rounded-lg overflow-hidden shadow-lg">
                ...
                <iframe width="1920" height="1080" src="https://www.youtube.com/embed/Y8kU484gyj8?si=vcgyfUzznVXIFqnx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            ...
            <div class="relative w-full rounded-lg overflow-hidden shadow-lg">
                ...
                <iframe width="1920" height="1080" src="https://www.youtube.com/embed/osS-Q9cpitM?si=wCdKL4uxs5XcxMu1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                {{-- <video class="w-full h-full aspect-video object-cover" controls poster="{{ asset('images/guide-thumbnail.jpg') }}">
                    <source
